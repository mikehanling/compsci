...
function test_part4(){
    ...
    res=$(eval $cmd)
    expect="Enter the length: Enter 5 numbers (space separated): Choose an operation: (0) : exit (1) : print array (2) : reverse array (3) : randomize array (4) : sort array { 0 1 2 3 4 }  Choose an operation: (0) : exit (1) : print array (2) : reverse array (3) : randomize array (4) : sort array { 3 1 2 4 0 }  Choose an operation: (0) : exit (1) : print array (2) : reverse array (3) : randomize array (4) : sort array "
    utest "$res" "$expect" "Randomize Array 1 ($cmd)"

    cmd="echo 5 0 1 2 3 4 1 3 3 0 | ./manipulator | tr '\n' ' ' "
    res=$(eval $cmd)
    expect="Enter the length: Enter 5 numbers (space separated): Choose an operation: (0) : exit (1) : print array (2) : reverse array (3) : randomize array (4) : sort array { 0 1 2 3 4 }  Choose an operation: (0) : exit (1) : print array (2) : reverse array (3) : randomize array (4) : sort array { 3 1 2 4 0 }  Choose an operation: (0) : exit (1) : print array (2) : reverse array (3) : randomize array (4) : sort array { 1 2 3 4 0 }  Choose an operation: (0) : exit (1) : print array (2) : reverse array (3) : randomize array (4) : sort array "
